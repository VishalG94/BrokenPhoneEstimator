...
router.post('/restaurantcontact', function (req, res) {
  ...
  kafka.make_request('restaurant_contact', req.body, function (err, results) {
    // console.log(results);
    if (err) {
      res.writeHead(400, {
        'Content-Type': 'text/plain'
...
router.get('/ownerdetails', function (req, res) {
  ...
  kafka.make_request('owner_details', req.query, function (err, results) {
    // console.log(results);
    if (err) {
      res.writeHead(400, {
        'Content-Type': 'text/plain'
...
router.get('/restaurantdetails', function (req, res) {
  ...
  kafka.make_request('restaurant_details', req.query, function (err, results) {
    // console.log(results);
    if (err) {
      res.writeHead(400, {
        'Content-Type': 'text/plain'
...
router.post('/updateownerphone', function (req, res) {
  ...
  console.log('Req Body : ', req.body)
  owners
    .update({ email: req.body.email }, { $set: { phone: req.body.newPhone } })
    .then(response => {
      console.log('response' + response)
      res.writeHead(200, {
        'Content-Type': 'text/plain'
...
router.post('/updateowneremail', function (req, res) {
  ...
  console.log('Req Body : ', req.body)
  owners
    .update({ email: req.body.email }, { $set: { email: req.body.newEmail } })
    .then(response => {
      console.log('response' + response)
      res.writeHead(200, {
        'Content-Type': 'text/plain'
...
router.post('/ownerimage', function (req, res) {
  ...
  kafka.make_request('owner_image', req.body, function (err, results) {
    // console.log(results);
    if (err) {
      res.writeHead(400, {
        'Content-Type': 'text/plain'
...
router.post('/ownerimageform', function (req, res) {
  ...
  upload(req, res, err => {
      if (err) {
        ...
        // console.log(req.file.email);
        if(req.file){
          kafka.make_request('owner_image_form', req.file, function (err, results) {
            // console.log(results);
            if (err) {
              res.writeHead(400, {
                'Content-Type': 'text/plain'
